...
namespace AppVendas.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,NomeProduto,Valor,QtdEstoque,CadastroAtivo,CategoriaId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ProdutoId,NomeProduto,Valor,QtdEstoque,CadastroAtivo,CategoriaId")] Produto produto)
        {
